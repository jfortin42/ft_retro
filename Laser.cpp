...
/*   Updated: 2017/01/10 16:21:23 by jfortin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Laser.hpp"

Laser::Laser(unsigned int hp_missile, unsigned int damageDeal, unsigned int speed_missile, unsigned int rateOfFire)
...
Laser::Laser(Laser const &src) : AWeapon(src.hp_missile, src.damageDeal, src.speed_missile, src.rateOfFire)
{
	*this = src;
}
